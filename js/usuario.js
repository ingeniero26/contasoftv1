...
function listar_productos_poco_stock() {
	...
	// facturas vencidas
	var t_facturas_vencidas;
function listar_facturas_credito_vencidas() {

	t_facturas_vencidas = $("#tbl_facturas_vencidas").DataTable({
		"ordering": false,
		"pageLength": 10,
		"destroy": true,
		"async": false,
		...
		"ajax": {
			"method": "POST",
			"url": "../controlador/usuario/control_facturas_credito_vencidas.php",
			data: {
