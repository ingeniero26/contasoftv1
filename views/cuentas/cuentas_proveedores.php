    ...
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-body">
             ...
             <table id="tabla_cuentas_proveedor" class="display responsive nowrap table-bordered" style="width:100%">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Proveedor</th>
...
<script type="text/javascript" src="../js/cuentas_x_pagar.js"></script>
    
    <script type="text/javascript">
        $(document).ready(function() {
           ListarCuenta_Proveedor();
          listar_combo_compra();
