...
class Modelo_Cliente {
	...
	function listar_cliente($idempresa){
		...
		, `persona`.`persona_tipodocumento`,persona.tipo_contribuyente 
    ...
    $correo,$idciudad,$idempresa,$id_tipo_tercero) {
		$sql = "call  SP_REGISTRAR_CLIENTE2('$nombre',
		'$apepat','$apemat','$numero','$tipo_doc',
		'$tipo_contribuyente', '$telefono','$direccion',
		'$correo','$idciudad','$idempresa','$id_tipo_tercero')";
			if($consulta = $this->conexion->conexion->query($sql)){
