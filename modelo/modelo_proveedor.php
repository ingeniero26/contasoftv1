...
class Modelo_Proveedor {
	...
	function Registrar_Proveedor($nombre,$apepat,$apemat,$numero,$tipo_doc,$sexo,$telefono,$direccion,$correo, $razon_social,$num_contacto,$idciudad,$idempresa) {
		$sql = "call  SP_REGISTRAR_PROVEEDOR2('$nombre','$apepat','$apemat','$numero','$tipo_doc','$sexo','$telefono','$direccion','$correo',  '$razon_social','$num_contacto','$idciudad', '$idempresa')";
			if($consulta = $this->conexion->conexion->query($sql)){
