...
class Modelo_Persona
{
    ...
    public function listar_persona($idempresa, $idtipo_tercero)
    {
        $sql = "SELECT
		`persona`.`persona_id`
	...
	FROM
        ...
        WHERE persona.`idempresa` = '$idempresa' AND tipo_tercero.`id` = '$idtipo_tercero'";
        $arreglo = array();
    ...
    public function Modificar_Estatus_Persona($persona_id, $estatus)
    {
