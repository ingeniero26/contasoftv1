...
class Modelo_Productos {
	...
	function listar_combo_categoria($idempresa) {
	...
	function listar_combo_unidad($idempresa) {
...
function listar_combo_tipo() {
	...
	function Modificar_Estatus_Producto($producto_id,$estatus) {
	...
	function Modificar_Producto($id_producto,$codigo_actual,
