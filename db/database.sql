...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.bodega: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.cuentas: ~114 rows (aproximadamente)
