...
insert  into `marcas`(`id`,`descripcion`,`estatus`,`fregistro`,`idempresa`) values (1,'HP','ACTIVO','2023-03-31 19:01:55',1);
...
CREATE TABLE `persona` (
  ...
  `regimen` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
insert  into `persona`(`persona_id`,`persona_nombre`,`persona_apepat`,`persona_apemat`,`tipo_contribuyente`,`contacto`,`persona_nrodocumento`,`persona_tipodocumento`,`persona_sexo`,`persona_telefono`,`persona_direccion`,`persona_correo`,`persona_fregistro`,`persona_estatus`,`idempresa`,`id_tipo_tercero`,`regimen`,`cupo`,`fecha_nacimiento`,`estatus`,`fregistro`) values (1,'JERSON','BATISTA','VEGA','Persona Natural',NULL,'1070813753','CEDULA','MASCULINO','30045454545','el centro','ingjerson@gmail.com','2022-07-13','ACTIVO',1,1,'COMUN',NULL,NULL,'ACTIVO','2023-03-10 18:56:43'),(2,'PROVEEDOR','DE MOSTRADOR','MOSTRADOR','Persona Natural',NULL,'000000001','NIT','MASCULINO','011111111','EL CENTRO','info@gmail.com','2022-07-13','ACTIVO',1,2,'COMUN',NULL,NULL,'ACTIVO','2023-03-10 18:56:46'),(3,'CLIENTE','DE ','MOSTRADOR','Persona Natural',NULL,'000000000001','CEDULA','MASCULINO','56456456','EL CENTRO','DEPRUEBA@GMAIL.COM','2022-07-13','ACTIVO',1,3,'COMUN',NULL,NULL,'ACTIVO','2023-03-10 18:57:23'),(4,'AGROPECUARIA','CAÑA ','FLECHA','Persona Juridica',NULL,'900312662','NIT','MASCULINO','3013794981','EL CARMEN DE BOLIVAR','info2022@gmail.com','2022-08-22','ACTIVO',1,1,'COMUN',NULL,NULL,'ACTIVO','2023-03-10 18:57:26'),(6,'PRUEBAS','PRUEBA','PRUEBA','Persona Juridica',NULL,'55646456','CEDULA','MASCULINO','56757','EL CENTRO','jerson564564@gmail.com','2022-11-05','ACTIVO',1,5,'COMUN',NULL,NULL,'ACTIVO','2023-03-10 18:57:29'),(7,'JUAN','PEDRO','PEDRO',NULL,NULL,'465465','CEDULA','','3013794981','EL CARMEN DE BOLIVAR','unitec13213@gmail.com','2022-12-03','ACTIVO',1,3,NULL,NULL,NULL,'ACTIVO','2023-03-10 18:57:35'),(8,'PRUEBAS','PRUEBA','PRUEBA',NULL,NULL,'4534534','CEDULA','NULL','56757','MONTE CARMELO','jerson@gmail.com','2022-12-03','ACTIVO',1,3,NULL,NULL,NULL,NULL,'2023-03-10 18:57:21');
...
insert  into `tipo_tercero`(`id`,`tipo`) values (1,'PROVEEDOR'),(2,'CLIENTE'),(3,'CODEUDOR'),(4,'EMPRESA'),(5,'EMPLEADO');
