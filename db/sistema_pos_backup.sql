...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.bodega: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.caja: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.cargos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.categoria: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.centro_costos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.ciudades: ~4 rows (aproximadamente)
INSERT INTO `ciudades` (`id`, `nombre_ciudad`, `idDepto`, `estatus`, `fregistro`) VALUES
	(1, 'EL CARMEN DE BOLIVAR', 1, 'ACTIVO', '2022-07-13 20:39:37'),
	(2, 'Cartagena', 1, 'ACTIVO', '2022-09-10 16:00:55'),
	(3, 'San Jacinto', 1, 'ACTIVO', '2022-09-10 17:04:26'),
	(4, 'San Juan Nepomuceno', 1, 'ACTIVO', '2022-09-10 17:04:54');
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.codeudor: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.compra: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.cuentas: ~90 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.departamentos: ~13 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.detalle_compra: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.detalle_venta: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.dpto: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.empleados: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.empresa: ~0 rows (aproximadamente)
INSERT INTO `empresa` (`ID`, `Nit`, `nombre`, `Representante`, `Direccion`, `Telefono`, `Correo`, `Logo`, `id_tipo_regimen`, `idCiudad`, `fregistro`, `estatus`) VALUES
	(1, '1070813753', 'JKSYSTEMAS', 'JERSON BATISTA', 'MONTE CARMELO', '3013794981', 'INGJERSON2014@GMAIL.COM', 'controlador/empresa/img/IMG61120239202.png', 2, 1, '2023-11-06 14:20:02', 'ACTIVO');
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.eps: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.gastos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.pension: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.persona: ~16 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.producto: ~23 rows (aproximadamente)
INSERT INTO `producto` (`producto_id`, `producto_codigo`, `producto_nombre`, `producto_descripcion`, `producto_cod_barra`, `producto_presentacion`, `id_bodega`, `cant_minima`, `producto_stock`, `id_categoria`, `id_unidad`, `idTipoProducto`, `id_marca`, `IdIva`, `producto_foto`, `compra`, `producto_precioventa`, `producto_estatus`, `fregistro`, `idempresa`) VALUES
	...
	(4, '9789589825785', 'AZUL RUBEN DARIO(4)', 'lorem ipsum', NULL, 'ATENEA', 1, '1', '5', 2, 1, 1, 1, 1, 'controlador/productos/img/default.png', 3000.00, 4000.00, 'ACTIVO', '2023-12-29 23:45:51', 1),
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.proveedor: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.tipo_comprobante: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.tipo_producto: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.usuario: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_pos_v2_desarrollo.venta: ~10 rows (aproximadamente)
