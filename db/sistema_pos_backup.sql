...
insert  into `ciudades`(`id`,`nombre_ciudad`,`idDepto`,`estatus`,`fregistro`) values (1,'EL CARMEN DE BOLIVAR',1,'ACTIVO','2022-07-13 08:39:37'),(2,'Cartagena',1,'ACTIVO','2022-09-10 04:00:55'),(3,'San Jacinto',1,'ACTIVO','2022-09-10 05:04:26'),(4,'San Juan Nepomuceno',1,'ACTIVO','2022-09-10 05:04:54');
...
insert  into `cliente`(`idcliente`,`cliente_fregistro`,`cliente_estatus`,`persona_id`,`idciudad`,`idempresa`) values (1,'2022-07-13','ACTIVO',3,1,1),(2,'2022-08-22','ACTIVO',4,1,1),(3,'2022-12-03','ACTIVO',7,1,1),(4,'2022-12-03','ACTIVO',8,3,1),(5,'2023-04-24','ACTIVO',10,1,1),(6,'2023-05-02','ACTIVO',11,3,1),(7,'2023-06-14','ACTIVO',17,4,1),(8,'2023-06-14','ACTIVO',18,4,1),(9,'2023-06-14','ACTIVO',19,2,1),(10,'2024-07-12','ACTIVO',25,1,1),(11,'2024-07-12','ACTIVO',26,1,1),(12,'2024-07-12','ACTIVO',27,1,1),(13,'2024-07-16','ACTIVO',28,1,1);
...
insert  into `concepto`(`id`,`descripcion`,`fregistro`,`estatus`,`idempresa`) values (1,'AUTO CONSUMO','2024-07-19 13:13:53','ACTIVO',1),(2,'Producto Defectuoso ','2024-07-20 12:25:36','INACTIVO',1);
...
insert  into `detalle_compra`(`detalle_compra_id`,`id_compra`,`id_producto`,`dc_cantidad`,`dc_precio`,`dc_descto`,`dc_estatus`) values (6,7,27,1000,1200,0,'INGRESADA');
...
insert  into `detalle_salida`(`id`,`idsalida`,`idproducto`,`cantidad`,`estatus`,`observaciones`,`created_at`) values (1,1,30,2,'INGRESADA','TEST','2024-07-23 09:40:22');
...
insert  into `detalle_venta`(`detalle_venta_id`,`venta_id`,`producto_id`,`dv_cantidad`,`dv_precio`,`dv_descuento`,`dv_estatus`) values (16,16,27,6.00,5.00,0.00,'INGRESADA'),(17,17,27,3.00,5.00,0.00,'INGRESADA'),(18,18,27,10.00,5000.00,0.00,'INGRESADA'),(19,19,42,1.00,300.00,0.00,'INGRESADA'),(20,20,42,2.00,300.00,0.00,'INGRESADA'),(21,21,42,3.00,300.00,0.00,'INGRESADA'),(22,22,42,2.00,300.00,0.00,'INGRESADA');
...
CREATE TABLE `empresa` (
  ...
  `Industria` enum('Services','Sales','Sports','Agriculture','Other') DEFAULT NULL,
...
insert  into `empresa`(`ID`,`Nit`,`nombre`,`Representante`,`Direccion`,`Telefono`,`Correo`,`Logo`,`Industria`,`id_tipo_regimen`,`idCiudad`,`fregistro`,`estatus`) values (1,'1070813753','JERSON-D','JERSON-D','EL CARMEN','3013230867','ingjerson2014@gmail.com','controlador/empresa/img/IMG61120239202.png','Sales',2,1,'2024-07-21 15:00:12','ACTIVO');
...
insert  into `iva`(`id`,`codigo`,`tarifa`,`nombre`,`idTipoImpuesto`,`estado`,`fregistro`,`idEmpresa`) values (1,'01',19,'IVA GENERAL DE PRODUCTOS',1,'ACTIVO','2023-11-17 04:43:42',1),(3,'02',0,'NO APLICA TARIFA',2,'ACTIVO','2023-11-26 18:00:00',1),(4,'03',5,'TARIFA 5%',1,'ACTIVO','2023-11-26 18:00:00',1);
...
insert  into `marcas`(`id`,`descripcion`,`estatus`,`fregistro`,`idempresa`) values (1,'HP','ACTIVO','2023-03-31 12:01:55',1),(2,'MARCA GENERAL','ACTIVO','2023-04-10 02:13:39',1),(3,'ACCER','ACTIVO','2023-04-10 01:33:54',1);
...
insert  into `persona`(`persona_id`,`persona_nombre`,`persona_apepat`,`persona_apemat`,`tipo_contribuyente`,`persona_nrodocumento`,`persona_tipodocumento`,`persona_telefono`,`persona_direccion`,`persona_correo`,`persona_fregistro`,`persona_estatus`,`idempresa`,`id_tipo_tercero`,`estatus`,`fregistro`) values (1,'JERSON','BATISTA','VEGA','Persona Natural','1070813753','CEDULA','30045454545','el centro','ingjerson@gmail.com','2022-07-13','ACTIVO',1,1,'ACTIVO','2023-03-10 12:56:43'),(2,'PROVEEDOR','DE MOSTRADOR','MOSTRADOR','Persona Natural','000000001','NIT','011111111','EL CENTRO','info@gmail.com','2022-07-13','ACTIVO',1,1,'ACTIVO','2023-06-14 09:58:42'),(3,'CLIENTE','CONSUMIDOR','FINAL','Persona Natural','000000000001','CEDULA','56456456','EL CENTRO','DEPRUEBA@GMAIL.COM','2022-07-13','ACTIVO',1,3,'ACTIVO','2024-07-23 15:42:54'),(4,'AGROPECUARIA','CAÃ‘A ','FLECHA','Persona Juridica','900312662','NIT','3013794981','EL CARMEN DE BOLIVAR','info20221@gmail.com','2022-08-22','ACTIVO',1,1,'ACTIVO','2023-06-14 08:40:56'),(6,'PRUEBAS','PRUEBA','PRUEBA','Persona Juridica','55646456','CEDULA','56757','EL CENTRO','jerson564564@gmail.com','2022-11-05','ACTIVO',1,5,'ACTIVO','2023-03-10 12:57:29'),(7,'JUAN','PEDRO','PEDRO','Persona Juridica','465465','CEDULA','3013794981','EL CARMEN DE BOLIVAR','unitec13213@gmail.com','2022-12-03','ACTIVO',1,3,'ACTIVO','2023-04-24 13:03:58'),(8,'PRUEBAS','PRUEBA','PRUEBA','Persona Juridica','4534534','CEDULA','56757','MONTE CARMELO','jerson@gmail.com','2022-12-03','ACTIVO',1,3,NULL,'2023-04-24 13:04:02'),(9,'PRUEBAS','PRUEBA','PRUEBA','Persona Natural','675675','NIT','3013794981','EL CARMEN DE BOLIVAR','jerson2@gmail.com','2023-04-24','ACTIVO',1,1,NULL,'2023-04-24 06:20:31'),(10,'JAMEZ','RODRIGUEZ','UNICARMEN','Persona Natural','56456456','NIT','3226165766','kra 45','unitec12165662@gmail.com','2023-04-24','ACTIVO',1,1,NULL,'2023-06-14 09:51:17'),(11,'UNICARMEN','PRUEBA','PRUEBA','Persona Natural','1','NIT','3226165766','3423423424234','unitec121212@gmail.com','2023-05-02','ACTIVO',1,1,NULL,'2023-06-14 09:51:18'),(12,'JAMEZ','RODRIGUEZ','VEGA','Persona Natural','78678678','NIT','3226165766','EL CARMEN DE BOLIVAR','jamez@hotmail.com','2023-05-24','ACTIVO',1,2,NULL,'2023-06-14 10:15:33'),(13,'SIIGO','PRUEBAS','PRUEBA','Persona Natural','6465465','NIT','3013794981','SIIGO@GMAIL.COM','jersonsiigo@gmail.com','2023-06-14','ACTIVO',1,1,NULL,'2023-06-14 09:59:46'),(16,'JUAN','GUILLERMO','cuadrado','Persona Natural','87896666','NIT','3013794981','MONTE CARMELO','juanguillermo@gmail.com','2023-06-14','ACTIVO',1,2,NULL,'2023-06-14 12:31:47'),(17,'federico','RODRIGUEZ','FLECHA','Persona Natural','6756756756','CEDULA','75675','EL CARMEN','unitec15656456@gmail.com','2023-06-14','ACTIVO',1,NULL,NULL,'2023-06-14 11:47:22'),(18,'PEDRO','BATISTA','VILLEGAS','Persona Natural','6657567567567','CEDULA','75675','kra 45','pedrobatista@gmail.com','2023-06-14','ACTIVO',1,2,NULL,'2023-06-14 12:20:49'),(19,'DENIS','BATISTA','ARROYO','Persona Natural','67567567','CEDULA','675675','MONTE CARMELO','DENISBATISTA@GMAIL.COM','2023-06-14','ACTIVO',1,3,NULL,'2023-06-14 12:29:56'),(20,'DENIS','BATISTA','ARROYO','Persona Natural','789654111','NIT','3013794981','EL CENTRO','denis2023@gmail.com','2023-08-16','ACTIVO',1,2,NULL,'2023-08-16 00:06:19'),(21,'YAHOO','YAHOO','DATOS','Persona Natural','34234234','NIT','23423','2342','','2023-09-18','ACTIVO',1,1,NULL,'2023-09-18 12:38:46'),(22,'MARK','SUKEMBER','VEGA','Persona Juridica','5645645','NIT','23423','EL CARMEN','info2021112@gmail.com','2023-09-18','ACTIVO',1,1,NULL,'2023-09-18 12:40:20'),(23,'test','test','test','Persona Natural','46456456','CEDULA','4546556','kra 45','test@test.com','2024-06-07','ACTIVO',1,1,NULL,'2024-06-07 14:08:08'),(25,'KAREN','HERNANDEZ','TORRES','Persona Natural','107895444','CEDULA','6567676','KR 45','karen@gmail.com','2024-07-12','ACTIVO',1,2,NULL,'2024-07-12 07:23:09'),(26,'JOSE','RAMIREZ','VEGA','Persona Natural','546456','CEDULA','5456456','KR 45','jose@gmail.com','2024-07-12','ACTIVO',1,2,NULL,'2024-07-12 07:28:34'),(27,'DANIEL','TORRES','VEGA','Persona Natural','657675','NIT','5656756','KR 45','danielgmail.com','2024-07-12','ACTIVO',1,2,NULL,'2024-07-12 08:02:13'),(28,'FALCAO','VEGA','BATISTA','Persona Natural','65756756','CEDULA','756756','6567567','falcao@gmail.com','2024-07-16','ACTIVO',1,2,NULL,'2024-07-16 06:35:44'),(29,'CONFITERIA ','LA ','UNICA','Persona Natural','455799314','CEDULA','03333333','EL CARMEN DE BOLIVAR','notiene1@gmail.com','2024-07-23','ACTIVO',1,1,NULL,'2024-07-23 08:26:40');
...
insert  into `producto`(`producto_id`,`producto_codigo`,`producto_nombre`,`producto_descripcion`,`producto_cod_barra`,`producto_presentacion`,`id_bodega`,`cant_minima`,`producto_stock`,`id_categoria`,`id_unidad`,`idTipoProducto`,`id_marca`,`IdIva`,`producto_foto`,`compra`,`producto_precioventa`,`producto_estatus`,`fregistro`,`idempresa`) values (27,'123','test','test','54354354353','test',1,'5','986',1,1,1,2,1,'controlador/productos/img/default.png',5.00,5.00,'ACTIVO','2024-07-22 15:08:57',1),(28,'0123','MAMUT * 42','GALLETAS','','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',450.00,600.00,'ACTIVO','2024-07-23 07:44:55',1),(29,'03214','NUCITA *18','NUCITAS','1','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',528.00,700.00,'ACTIVO','2024-07-23 07:51:51',1),(30,'2','WAFER CAPRI','NUCITAS','2','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',245.00,300.00,'ACTIVO','2024-07-23 07:57:28',1),(31,'0019','TRULULU ARO','TRULULU','4','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',158.00,200.00,'ACTIVO','2024-07-23 08:02:42',1),(32,'0144','BIANCHI','DULCES','5','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',500.00,200.00,'ACTIVO','2024-07-23 08:05:51',1),(33,'014','MUU MANTEQUILLA','DULCES','6','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',416.00,500.00,'ACTIVO','2024-07-23 08:08:49',1),(34,'037','GALLETAS TOS','DULCES','7','GENERAL',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',755.00,1000.00,'ACTIVO','2024-07-23 08:10:56',1),(35,'0469','MASMELO','DULCES','8','GENERAL',1,'','0',6,1,1,2,1,'controlador/productos/img/default.png',80.00,200.00,'ACTIVO','2024-07-23 08:13:03',1),(36,'0413','MINIBUM','DULCES','9','GN',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',54.00,198.00,'ACTIVO','2024-07-23 08:14:31',1),(37,'002','FESTIVAL GRANDE','DULCES','10','GN',1,'','0',6,1,1,2,1,'controlador/productos/img/default.png',1083.00,1300.00,'ACTIVO','2024-07-23 08:16:29',1),(38,'0249','PAPA RULA 800 FRITOMIX','DULCES','11','GN',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',650.00,800.00,'ACTIVO','2024-07-23 08:18:29',1),(39,'0257','CROCAN NACHO','DULCES','12','GN',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',660.00,1000.00,'ACTIVO','2024-07-23 08:21:10',1),(40,'0282','LOKIÑO MASTICABLE','DULCES','13','GN',1,'2','0',6,1,1,2,1,'controlador/productos/img/default.png',50.00,100.00,'ACTIVO','2024-07-23 08:22:17',1),(41,'0626','TICO 900','DULCES','14','GN',1,'','0',6,1,1,2,1,'controlador/productos/img/default.png',800.00,1000.00,'ACTIVO','2024-07-23 08:23:35',1),(42,'1000','COPIAS BLANCO Y NEGRO','SERVICIOS','10000','general',1,'2','92',4,1,4,2,3,'controlador/productos/img/default.png',0.00,300.00,'ACTIVO','2024-07-25 10:21:05',1);
...
insert  into `proveedor`(`proveedor_id`,`proveedor_fregistro`,`proveedor_num_contacto`,`proveedor_estatus`,`persona_id`,`proveedor_razon_social`,`idciudad`,`idempresa`) values (1,'2022-07-13','000001','ACTIVO',2,'MOSTRADOR ',1,1),(2,'2023-04-24','67567567','ACTIVO',9,'probando ando ANDO',1,1),(3,'2023-05-24','45435345','ACTIVO',12,'JAMEZ PROBANDO',2,1),(4,'2023-06-14','67567567','ACTIVO',13,'SIIGO PRUEBAS',1,1),(5,'2023-09-18','67567567','ACTIVO',22,'MARK VEGA',1,1),(6,'2024-06-07','','ACTIVO',23,'',1,1),(7,'2024-07-23','','ACTIVO',29,'CONFITERIA ',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='detalle cotizacion';

/*Data for the table `quotation_detail` */

insert  into `quotation_detail`(`id`,`quote_id`,`producto_id`,`cantidad`,`precio`,`descuento`,`estatus`) values (4,7,27,9.00,5.00,0.00,'INGRESADA'),(5,8,27,7.00,500.00,0.00,'INGRESADA'),(6,9,27,7.00,5.00,0.70,'INGRESADA'),(7,10,27,6.00,5.00,0.60,'INGRESADA'),(8,11,27,18.00,5000.00,1800.00,'INGRESADA'),(9,12,27,8.00,5.00,0.80,'INGRESADA');
...
CREATE TABLE `salida` (
  ...
  KEY `idusuario` (`idusuario`),
  KEY `FK_salida_empresa` (`idEmpresa`),
  CONSTRAINT `FK_salida_bodega` FOREIGN KEY (`idBodega`) REFERENCES `bodega` (`id`),
  CONSTRAINT `FK_salida_concepto` FOREIGN KEY (`idConcepto`) REFERENCES `concepto` (`id`),
  CONSTRAINT `FK_salida_empresa` FOREIGN KEY (`idEmpresa`) REFERENCES `empresa` (`ID`),
  CONSTRAINT `FK_salida_usuario` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `salida` */

insert  into `salida`(`id`,`idConcepto`,`fecha`,`idBodega`,`idusuario`,`idEmpresa`,`created_at`) values (1,1,'2024-07-23',1,1,1,'2024-07-23 09:38:44');
