                ...
                <form method="POST" action="#"  enctype="multipart/form-data" onsubmit="return false">
                    <div class="m-t-20">
                        <img class="img-circle" id="txt_image_profile"  />
                         ...
                         <div>
                        <button class="btn btn-info btn-rounded m-b-10" onclick="Editar_Foto_Profile()"><i class="fa fa-plus"></i> Actualizar</button>
                        ...
                        <div class="ibox">
                            <div class="ibox-body">
                                <ul class="nav nav-tabs tabs-line">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#tab-3" data-toggle="tab"><i class="ti-announcement"></i> Actualizar Contraseña</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="tab-2">
                                      <div class="row">
                                          ...
                                          <div class="col-lg-6">
                                              ...
                                              <select class="js-example-basic-single" name="state" style="width: 100%;" id="cmb_tipodocumento_profile" >
                                          ...
                                          <div class="col-lg-6">
                                              ...
                                              <input type="text" id="txt_telefono_profile" class="form-control" onkeypress="return soloNumeros(event)">
                                          </div>
                                           <div class="col-lg-12">
