                    ...
                    <div class="col-3">
                     ...
                     <div class="col-lg-12">
                       ...
                       <label for=""><b>Producto</b> </label>
                        <select class="js-example-basic-single"
                         name="state" style="width: 100%;" id="cmb_producto">
                     ...
                     <div class="col-2">
                        ...
                        <input type="number" 
                        onkeypress="return filterfloat(event,this);" min="1" 
                        class="form-control" id="txt_stock" disabled="">
                    </div>
                     <div class="col-2">
                        <label for=""><b>Precio Venta</b></label>
                        <input type="number" 
                        onkeypress="return filterfloat(event,this);" min="1" class="form-control"
                        id="txt_precio" >
                    </div>
                    <!-- <div class="col-2">
