	...
	$consulta = "SELECT  * FROM unidad
        ...
        while($filas = $resultado ->fetch_assoc()) {
          ...
          $html.='<tr>
            ...
            <td class="desc">'.$filas['unidad_nombre'].'</td>
            <td class="desc">'.$filas['unidad_abreviatura'].'</td>
            <td class="unit">'.$filas['unidad_fregistro'].'</td>
            <td class="unit">'.$filas['unidad_estatus'].'</td>'
